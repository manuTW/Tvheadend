...
The build machine should install docker and docker-compose in advance.
...
1. generate source volume for building tvheadend
	...
	b. command:
		$ cd build; docker build -t tv407build .
...
2. generate pre-tvheadend image
	- Compose file: build/docker-compose.yml
		...
		+ source volume: tv407build as in step 1
	- the tvheadend is installed after this step

3. insert kernel module as tv407
